          ...
          {isOpen ? (
            ...
            >
              <span className="text-xl font-bold tracking-tighter text-white flex items-center">
                <img src={logoUrl} alt="TournaHub" className="w-10 h-10 mr-3 object-contain" referrerPolicy="no-referrer" />
            ...
            >
              <img src={logoUrl} alt="TournaHub" className="w-8 h-8 object-contain" referrerPolicy="no-referrer" />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
