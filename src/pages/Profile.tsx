                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-2 relative">
                      ...
                      <div className="flex items-center bg-[#111218]/80 border border-zinc-800 rounded-2xl h-14 px-4 gap-3 focus-within:ring-1 focus-within:ring-emerald-500/40 focus-within:border-emerald-500/40 transition-all">
                        <span className="text-emerald-400 font-extrabold italic text-sm leading-none select-none shrink-0">
                          {getCountryCallingCode(selectedCountry) ? `+${getCountryCallingCode(selectedCountry)}` : ''}
                        </span>
                        <input
                          type="tel"
                          disabled={waLoading}
                          className="flex-1 bg-transparent border-none outline-none font-bold text-white placeholder-zinc-700 py-3 h-full min-w-0"
