  ...
  return (
    <Shell>
      <div className="space-y-8">
        <h1 className="text-3xl font-black text-white uppercase italic tracking-tighter">Profile</h1>

        {/* Profile Info Card */}
        <div className="card p-10 bg-gradient-to-br from-[#1c1f3e] to-[#0a0b1e] border-slate-800 shadow-2xl space-y-8 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -mr-20 -mt-20" />
          
          <div className="flex flex-col items-center text-center space-y-6 relative z-10">
            <div className="w-28 h-28 rounded-full bg-slate-900 border-4 border-slate-800 flex items-center justify-center text-primary font-black text-4xl shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]">
              {initial}
            </div>
            <div className="space-y-1">
              <h2 className="text-2xl font-black text-white italic uppercase tracking-tighter truncate max-w-[300px]">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="card p-6 bg-sky-500/5 border-sky-500/10 flex flex-col items-center justify-center text-center space-y-1">
             ...
             <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider leading-tight">Tournaments</span>
          </div>
          <div className="card p-6 bg-indigo-500/5 border-indigo-500/10 flex flex-col items-center justify-center text-center space-y-1">
             ...
             <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider leading-tight">Matches</span>
          </div>
          <div className="card p-6 bg-emerald-500/5 border-emerald-500/10 flex flex-col items-center justify-center text-center space-y-1">
             ...
             <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider leading-tight">Wins</span>
          </div>
        </div>

        {/* Operations */}
        <div className="space-y-4">
          <h3 className="text-xl font-black text-white uppercase italic tracking-tighter">Operations</h3>
          ...
          {profile?.role === 'admin' && (
            <Link to="/admin" className="card p-6 bg-primary/10 border-primary/20 flex items-center justify-between group hover:bg-primary/20 transition-all cursor-pointer mb-4">
              <div className="flex items-center space-x-6">
                ...
                <div>
                  <h4 className="text-lg font-black text-white italic uppercase tracking-tighter leading-tight">Admin Control</h4>
          ...
          <div className="card p-6 bg-surface/30 border-white/5 flex items-center justify-between group hover:border-primary/20 transition-all cursor-pointer">
            <div className="flex items-center space-x-6">
              <div className="w-12 h-12 rounded-xl bg-sky-500/10 flex items-center justify-center border border-sky-500/20">
                <Shield className="w-6 h-6 text-sky-400" />
              </div>
              <div>
                <h4 className="text-lg font-black text-white italic uppercase tracking-tighter leading-tight">Role Access</h4>
                <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">{profile?.role || 'ADMIN'}</p>
              </div>
            </div>
            <ArrowRight className="w-6 h-6 text-slate-700 group-hover:text-primary transition-colors" />
          </div>
        </div>
